...
class MainDatabaseService extends ChangeNotifier {
  ...
  Future<void> init() async {
    final url = dotenv.env['SUPABASE_MAIN_URL']?.isNotEmpty == true ? dotenv.env['SUPABASE_MAIN_URL']! : 'https://placeholder.supabase.co';
    final key = dotenv.env['SUPABASE_MAIN_ANON_KEY']?.isNotEmpty == true ? dotenv.env['SUPABASE_MAIN_ANON_KEY']! : 'placeholder';
