...
class SupabaseAuthService extends ChangeNotifier {
  ...
  Future<({bool success, String message})> _offlineLogin(
    ...
    // SECURITY FIX: Removed hardcoded offline credentials (backdoor bypass)
    // Always fail securely when database is unreachable.
    return (success: false, message: 'System offline. Authentication unavailable.');
  }
